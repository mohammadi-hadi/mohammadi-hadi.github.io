...
CARDS = [
    ...
    dict(name="what-arena-votes-can-and-cannot-order", kicker="Field notes",
         ...
         subtitle="Of 54 neighbouring pairs on the board, one separates",
         foot_left="mohammadi.cv/blog", foot_right="6 min read"),
    dict(name="the-benchmark-that-was-measuring-length", kicker="Field notes",
         title="The benchmark that was measuring length",
         subtitle="wc -c beat the deployed encoder on our own evaluation pool",
    ...
    dict(name="two-systems-that-agree-on-almost-nothing", kicker="Field notes",
         ...
         subtitle="Same 18,002 jobs, same candidates, 3.6% agreement on the best one",
         foot_left="mohammadi.cv/blog", foot_right="6 min read"),
    dict(name="a-metric-that-moves-when-the-model-does-not", kicker="Field notes",
         title="A metric that moves when the model does not",
         subtitle="Weighted kappa climbed and fell while the ranking stayed flat",
         foot_left="mohammadi.cv/blog", foot_right="6 min read"),
    dict(name="4873-experiments-and-the-winners-curse", kicker="Field notes",
         title="4,873 experiments and the winner’s curse",
         subtitle="15% fail their traffic-split check before anyone reads the p-value",
         foot_left="mohammadi.cv/blog", foot_right="5 min read"),
    dict(name="what-a-benchmark-can-tell-apart", kicker="Field notes",
         title="What a benchmark can actually tell apart",
         subtitle="HumanEval catches a real three-point gap about one time in seven",
         foot_left="mohammadi.cv/blog", foot_right="4 min read"),
    dict(name="how-much-text-a-watermark-needs", kicker="Field notes",
         ...
         foot_left="mohammadi.cv/blog", foot_right="5 min read"),
    dict(name="ask-a-model-how-sure-it-is", kicker="Field notes",
         title="Ask a model how sure it is",
         subtitle="One model said 100 on 593 answers and was wrong on 236 of them",
         foot_left="mohammadi.cv/blog", foot_right="5 min read"),
    dict(name="what-a-context-window-forgets", kicker="Field notes",
         title="What a context window forgets",
         subtitle="A sliding window holds the answer for 8% of questions where search holds 60%",
         foot_left="mohammadi.cv/blog", foot_right="5 min read"),
